...
You completed [module 1](http://ibmstreams.github.io/streamsx.tutorial.teda/docs/2.0.0/Module-1/), which guided you through the installation of the TEDA plug-in for Streams Studio and the setup and configuration of the Monitoring GUI.
...
<img src="/streamsx.tutorial.teda/images/2.0.0/module-02/NewProjectWizards.png" alt="New Project dialog"/>
...
<img src="/streamsx.tutorial.teda/images/2.0.0/module-02/NewITEApplicationProjectWizard.png" alt="ITE Application Project wizard"/>
...
<img src="/streamsx.tutorial.teda/images/2.0.0/module-02/ProjectExplorerAfterProjectCreation.png" alt="Project Explorer showing the content of the created SPL project" style="width: 80%;"/>
...
<img src="/streamsx.tutorial.teda/images/2.0.0/module-02/DisabledAutomaticBuild.png" alt="Build Automatically menu item in Project menu"/>
...
<img src="/streamsx.tutorial.teda/images/2.0.0/module-02/RightClickBuildProject.png" alt="Right-click Build Project"/>
...
<img src="/streamsx.tutorial.teda/images/2.0.0/module-02/RightClickLaunch.png" alt="Launch demoapp application" style="width: 80%;"/>
...
<img src="/streamsx.tutorial.teda/images/2.0.0/module-02/MonitoringGUI.png" alt="Monitoring GUI after job submission"/>
...
<img src="/streamsx.tutorial.teda/images/2.0.0/module-02/ProjectExplorerDataDirectory.png" alt="Project Explorer shows the data directory tree"/>
...
<img src="/streamsx.tutorial.teda/images/2.0.0/module-02/ProjectExplorerDataDirectoryWithFiles.png" alt="Project Explorer shows the data directory tree with processed files"/>

After refreshing the Monitoring GUI (press F5), the changed metrics reflect that the file is processed.

<img src="/streamsx.tutorial.teda/images/2.0.0/module-02/MonitoringGUIAfterDataProcessing.png" alt="Monitoring GUI after data processing"/>
