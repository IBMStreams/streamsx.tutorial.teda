...
You find the **com.ibm.streams.teda** toolkit documentation in IBM Knowledge Center: [version 1.0.2](http://www-01.ibm.com/support/knowledgecenter/SSCRJU_4.1.1/com.ibm.streams.toolkits.doc/spldoc/dita/tk$com.ibm.streams.teda/tk$com.ibm.streams.teda.html)
